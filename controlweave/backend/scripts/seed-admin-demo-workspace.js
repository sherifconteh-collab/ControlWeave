...
const DEMO_ORG_NAME = 'Meridian Financial Group';
const DEMO_ADMIN_EMAIL = 'admin@enterprise.com';
const DEMO_ADMIN_PASSWORD = 'ControlWeave!2026';
...
const DEMO_TEAM_USERS = [
  {
    email: 'auditor.lead@enterprise.com',
    firstName: 'Avery',
    lastName: 'Auditor',
    role: 'auditor',
  ...
  {
    email: 'auditor.staff@enterprise.com',
    firstName: 'Morgan',
    lastName: 'Fieldwork',
    role: 'auditor',
  ...
  {
    email: 'leadership@enterprise.com',
    firstName: 'Riley',
    lastName: 'Leadership',
    role: 'user',
    preferredRole: 'user'
