...
const frameworks = [
  ...
  {
    // Full 300 base controls generated from the official NIST OSCAL SP
    // 800-53 Rev 5.2.0 catalog via scripts/import-oscal-80053.js -- see
    // docs/FRAMEWORK_CATALOG_COMPLETION_PLAN.md Wave 1. Re-run the
    // importer against an updated catalog rather than hand-editing
    // scripts/lib/frameworks/nist_800_53.js.
    // code/name are literal (not sourced from NIST_800_53.framework) because
    // .github/workflows CI's TEVV-DB regression guard greps this file for
    // the literal string `code: 'nist_800_53'` to catch a framework being
    // silently dropped -- see the CI job "Database & Migration Integrity".
    code: 'nist_800_53', name: 'NIST SP 800-53 Rev 5', version: NIST_800_53.framework.version,
    category: NIST_800_53.framework.category, tier_required: NIST_800_53.framework.tier_required,
    description: NIST_800_53.framework.description,
