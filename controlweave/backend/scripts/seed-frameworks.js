...
const frameworks = [
  ...
  },
  {
    ...
    controls: [
      ...
      { control_id: 'CA-2', title: 'Control Assessments', description: 'Assess controls in the system and its environment of operation to determine the extent to which the controls are implemented correctly, operating as intended, and producing the desired outcome.', priority: '1', control_type: 'organizational' },
      { control_id: 'CA-7', title: 'Continuous Monitoring', description: 'Develop a system-level continuous monitoring strategy and implement continuous monitoring in accordance with the organization-level strategy including ongoing assessment, monitoring, and reporting.', priority: '1', control_type: 'organizational' },
      // Planning
      { control_id: 'PL-2', title: 'System Security and Privacy Plans', description: 'Develop security and privacy plans for the system that are consistent with the enterprise architecture, identify authorized users, and describe the security and privacy controls in place or planned.', priority: '1', control_type: 'policy' },
      // Program Management
      { control_id: 'PM-9', title: 'Risk Management Strategy', description: 'Develop and implement an organization-wide strategy for managing security and privacy risk including techniques and methodologies, organization-defined constraints, and approaches for monitoring risk over time.', priority: '1', control_type: 'strategic' },
      { control_id: 'PM-23', title: 'Data Governance Body', description: 'Establish a Data Governance Body consisting of organization-defined roles with responsibilities for coordinating data governance activities including data quality, privacy, and lifecycle management.', priority: '2', control_type: 'organizational' },
    ]
  },
  {
  ...
  {
    // Full 110 CMMC 2.0 Level 2 practices, generated from a NIST SP 800-171
    // Rev 2 OSCAL catalog via scripts/import-oscal-cmmc-l2.js -- see
    // docs/FRAMEWORK_CATALOG_COMPLETION_PLAN.md Wave 1. Re-run the importer
    // against an updated catalog rather than hand-editing
    // scripts/lib/frameworks/cmmc_2_0.js.
    // code/name are literal for consistency with how nist_800_53 guards
    // against CI's TEVV-DB regression grep (see that framework's comment) --
    // cmmc_2.0 isn't in that grep list today, but keeping the pattern
    // consistent avoids a silent surprise if it's ever added.
    code: 'cmmc_2.0', name: 'CMMC 2.0 (Level 2)', version: CMMC_2_0.framework.version,
    category: CMMC_2_0.framework.category, tier_required: CMMC_2_0.framework.tier_required,
    description: CMMC_2_0.framework.description,
    controls: CMMC_2_0.controls
  },
  {
  ...
  {
    code: 'fiscam', name: 'FISCAM', version: '2024',
  ...
  },
  {
    ...
    controls: [
      ...
      { control_id: 'MAP-4', title: 'AI Risks and Benefits Communicated', description: 'Risks and benefits of the AI system to all stakeholders are understood and communicated across the AI lifecycle.', priority: '1', control_type: 'organizational' },
  ...
  },
  {
    ...
    controls: [
      ...
      { control_id: 'HIPAA-164.314(a)(1)', title: 'Business Associate Contracts', description: 'The contract between the covered entity and its business associate must meet the applicable requirements of §164.504(e), including safeguarding ePHI.', priority: '1', control_type: 'organizational' }, // ip-hygiene:ignore
      { control_id: 'HIPAA-164.314(b)(1)', title: 'Requirements for Group Health Plans', description: 'Plan documents of the group health plan must be amended to incorporate provisions requiring the plan sponsor to reasonably and appropriately safeguard ePHI.', priority: '2', control_type: 'organizational' }, // ip-hygiene:ignore
      // §164.316 Policies, Procedures, and Documentation
      { control_id: 'HIPAA-164.316(a)', title: 'Policies and Procedures', description: 'Implement reasonable and appropriate policies and procedures to comply with the standards, implementation specifications, and other requirements of the HIPAA Security Rule.', priority: '1', control_type: 'policy' }, // ip-hygiene:ignore
      { control_id: 'HIPAA-164.316(b)(1)', title: 'Documentation', description: 'Maintain the policies and procedures implemented to comply with this subpart in written (which may be electronic) form, and maintain a written record of any action, activity, or assessment required by this subpart.', priority: '1', control_type: 'policy' }, // ip-hygiene:ignore
      { control_id: 'HIPAA-164.316(b)(2)', title: 'Documentation - Time Limit, Availability, Updates', description: 'Retain documentation for 6 years from its creation or last effective date. Make documentation available to those responsible for implementing procedures, and review periodically.', priority: '2', control_type: 'policy' }, // ip-hygiene:ignore
    ]
  },
  {
  ...
  },
  {
    ...
    controls: [
      ...
      { control_id: 'ISO42-A.2.2', title: 'Processes for Responsible AI Use', description: 'Establish and implement processes to ensure responsible use of AI systems within the organization.', priority: '1', control_type: 'policy' },
      { control_id: 'ISO42-A.3.2', title: 'AI System Impact Assessment Process', description: 'Define and apply a structured process for assessing AI system impacts throughout the lifecycle.', priority: '1', control_type: 'strategic' },
      { control_id: 'ISO42-A.4.1', title: 'AI System Documentation Requirements', description: 'Maintain documentation for AI systems covering purpose, design decisions, training data, and limitations.', priority: '2', control_type: 'organizational' },
      { control_id: 'ISO42-A.5.1', title: 'AI System Use Constraints', description: 'Define and enforce constraints on AI system use to limit harm and ensure intended application.', priority: '1', control_type: 'policy' },
      { control_id: 'ISO42-A.6.1', title: 'AI Use Policy', description: 'Establish and communicate an organizational policy for AI use covering acceptable applications and prohibited uses.', priority: '1', control_type: 'policy' },
      { control_id: 'ISO42-A.6.2', title: 'AI Risk Assessment Processes', description: 'Apply structured risk assessment processes to identify, analyze, and evaluate AI-related risks.', priority: '1', control_type: 'strategic' },
      { control_id: 'ISO42-A.7.2', title: 'AI System Lifecycle Controls', description: 'Implement controls across the full AI system lifecycle from design through deployment and decommissioning.', priority: '1', control_type: 'technical' },
      { control_id: 'ISO42-A.8.1', title: 'AI System Deployment Controls', description: 'Establish controls governing deployment of AI systems including testing, validation, and approval.', priority: '1', control_type: 'technical' },
      { control_id: 'ISO42-A.9.1', title: 'Third-Party AI Provisions', description: 'Define requirements for third parties providing AI systems or AI-enabled services to the organization.', priority: '2', control_type: 'organizational' },
      { control_id: 'ISO42-A.10.1', title: 'AI System Monitoring and Improvement', description: 'Monitor deployed AI systems for performance, drift, bias, and unintended behavior and drive continuous improvement.', priority: '1', control_type: 'technical' },
    ]
  },
  {
  ...
  // === PROFESSIONAL TIER: Payment Card Industry ===
  {
    code: 'pci_dss_v4', name: 'PCI DSS v4.0', version: '4.0',
    category: 'Payment Security', tier_required: 'pro',
    ...
    controls: [
      ...
      { control_id: 'PCI-1.1', title: 'Network Security Controls — Defined and Documented', description: 'Processes and mechanisms for installing and maintaining network security controls are defined and understood.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-1.2', title: 'Network Security Controls — Implemented', description: 'Network security controls (NSCs) are configured and maintained to restrict inbound and outbound traffic to only that which is necessary.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-1.3', title: 'Network Access Restricted Between CDE and Other Networks', description: 'Network access to and from the cardholder data environment (CDE) is restricted.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-1.4', title: 'Network Connections Between Trusted and Untrusted Networks', description: 'Network connections between trusted and untrusted networks are controlled.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-1.5', title: 'Risks to the CDE from Computing Devices', description: 'Risks to the CDE from computing devices that can connect to both untrusted networks and the CDE are mitigated.', priority: '2', control_type: 'technical' },
      // Requirement 2: Secure Configurations
      { control_id: 'PCI-2.1', title: 'Secure Configurations — Processes Defined', description: 'Processes and mechanisms for applying secure configurations to all system components are defined and understood.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-2.2', title: 'System Components Configured Securely', description: 'System components are configured and managed securely with industry-accepted hardening standards.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-2.3', title: 'Wireless Environments Configured Securely', description: 'Wireless environments are configured and managed securely.', priority: '2', control_type: 'technical' },
      // Requirement 3: Protect Stored Account Data
      { control_id: 'PCI-3.1', title: 'Account Data Storage — Processes Defined', description: 'Processes and mechanisms for protecting stored account data are defined and understood.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-3.2', title: 'Storage of Account Data is Kept to a Minimum', description: 'Storage of account data is kept to a minimum through data retention and disposal policies and processes.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-3.3', title: 'Sensitive Authentication Data Not Retained After Authorization', description: 'Sensitive authentication data (SAD) is not retained after authorization.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-3.4', title: 'Access to PAN is Restricted', description: 'Access to the full contents of any PAN is restricted. Display of the primary account number (PAN) is restricted to those with a business need.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-3.5', title: 'Primary Account Number is Secured', description: 'The primary account number (PAN) is secured with strong cryptography when transmitted or stored.', priority: '1', control_type: 'technical' },
      // Requirement 4: Protect Cardholder Data with Strong Cryptography
      { control_id: 'PCI-4.1', title: 'Cryptography for Transmission — Processes Defined', description: 'Processes and mechanisms for protecting cardholder data with strong cryptography during transmission over open networks are defined and understood.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-4.2', title: 'PAN Protected with Strong Cryptography During Transmission', description: 'PAN is protected with strong cryptography during transmission over open, public networks.', priority: '1', control_type: 'technical' },
      // Requirement 5: Malware Protection
      { control_id: 'PCI-5.1', title: 'Malware Protection — Processes Defined', description: 'Processes and mechanisms for protecting all systems against malware are defined and understood.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-5.2', title: 'Malware Protection in Place', description: 'Malware (malicious software) is prevented, or detected and addressed.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-5.3', title: 'Anti-Malware Mechanisms Actively Running', description: 'Anti-malware mechanisms and processes are active, maintained, and monitored.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-5.4', title: 'Anti-Phishing Mechanisms in Place', description: 'Anti-phishing mechanisms protect users against phishing attacks.', priority: '2', control_type: 'technical' },
      // Requirement 6: Develop and Maintain Secure Systems
      { control_id: 'PCI-6.1', title: 'Secure Systems Development — Processes Defined', description: 'Processes and mechanisms for developing and maintaining secure systems and software are defined and understood.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-6.2', title: 'Bespoke and Custom Software Developed Securely', description: 'Bespoke and custom software are developed securely.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-6.3', title: 'Security Vulnerabilities Identified and Addressed', description: 'Security vulnerabilities are identified and protected from exploitation.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-6.4', title: 'Public-Facing Web Applications Protected', description: 'Public-facing web applications are protected against attacks.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-6.5', title: 'Changes to System Components are Managed Securely', description: 'Changes to system components in the production environment are authorized, documented, and managed in accordance with the change control process.', priority: '1', control_type: 'organizational' },
      // Requirement 7: Restrict Access by Business Need
      { control_id: 'PCI-7.1', title: 'Access Control — Processes Defined', description: 'Processes and mechanisms for restricting access to system components and cardholder data by business need to know are defined and understood.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-7.2', title: 'Access to System Components and Data is Appropriately Defined', description: 'Access to system components and data is appropriately defined and assigned to individuals and roles based on job classification and function.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-7.3', title: 'Access to System Components and Data is Managed via Access Control System', description: 'Access to system components and data is managed via an access control system(s).', priority: '1', control_type: 'technical' },
      // Requirement 8: Identify Users and Authenticate
      { control_id: 'PCI-8.1', title: 'User Identity and Authentication — Processes Defined', description: 'Processes and mechanisms for identifying and authenticating access to system components are defined and understood.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-8.2', title: 'User IDs and Authentication Credentials are Managed for Non-Consumer Users', description: 'User identification and related accounts are strictly managed throughout the lifecycle.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-8.3', title: 'User Authentication for Non-Consumer Users and Administrators is Established', description: 'User authentication for non-consumer users and administrators is established and managed.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-8.4', title: 'Multi-Factor Authentication Implemented', description: 'Multi-factor authentication (MFA) is implemented to secure access into the CDE.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-8.5', title: 'Multi-Factor Authentication Systems Managed', description: 'Multi-factor authentication (MFA) systems are configured to prevent misuse.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-8.6', title: 'Use of Application and System Accounts Managed', description: 'Use of application and system accounts and associated authentication factors is strictly managed.', priority: '1', control_type: 'technical' },
      // Requirement 9: Physical Access
      { control_id: 'PCI-9.1', title: 'Physical Security — Processes Defined', description: 'Processes and mechanisms for restricting physical access to cardholder data are defined and understood.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-9.2', title: 'Physical Access Controls Implemented', description: 'Physical access controls manage entry into facilities and systems containing cardholder data.', priority: '2', control_type: 'physical' },
      { control_id: 'PCI-9.3', title: 'Physical Access for Personnel and Visitors Authorized and Managed', description: 'Physical access for personnel and visitors is authorized and managed.', priority: '2', control_type: 'physical' },
      { control_id: 'PCI-9.4', title: 'Media with Cardholder Data is Secured', description: 'Media with cardholder data is secured.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-9.5', title: 'Point of Interaction Devices Protected', description: 'Point of interaction (POI) devices are protected from tampering and unauthorized substitution.', priority: '1', control_type: 'physical' },
      // Requirement 10: Log and Monitor
      { control_id: 'PCI-10.1', title: 'Logging and Monitoring — Processes Defined', description: 'Processes and mechanisms for logging and monitoring all access to system components and cardholder data are defined and documented.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-10.2', title: 'Audit Logs Are Implemented', description: 'Audit logs capture all individual user access, all actions taken with root/administrative privileges, access to audit trails, invalid logical access, use of identification and authentication mechanisms, initialization/stopping/pausing of audit logs, creation/deletion of system objects.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-10.3', title: 'Audit Logs Are Protected', description: 'Audit logs are protected to prevent modifications.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-10.4', title: 'Audit Logs Are Reviewed', description: 'Audit logs are reviewed to identify anomalies or suspicious activity.', priority: '1', control_type: 'organizational' },
      { control_id: 'PCI-10.5', title: 'Audit Log History Is Retained', description: 'Retain audit log history for at least 12 months, with at least the most recent three months available for immediate analysis.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-10.6', title: 'Time-Synchronization Mechanisms Support Consistent Time Settings', description: 'Time-synchronization technology supports consistent time settings across all systems.', priority: '2', control_type: 'technical' },
      { control_id: 'PCI-10.7', title: 'Failures of Critical Security Controls Are Detected', description: 'Failures of critical security controls are detected, reported, and responded to promptly.', priority: '1', control_type: 'technical' },
      // Requirement 11: Test Security
      { control_id: 'PCI-11.1', title: 'Security Testing — Processes Defined', description: 'Processes and mechanisms for regularly testing security of systems and networks are defined and understood.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-11.2', title: 'Wireless Access Points Are Identified and Monitored', description: 'Wireless access points are identified and monitored, and unauthorized wireless access points are addressed.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-11.3', title: 'External and Internal Vulnerabilities Are Regularly Identified', description: 'External and internal vulnerabilities are regularly identified, prioritized, and addressed.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-11.4', title: 'External and Internal Penetration Testing', description: 'External and internal penetration testing is regularly performed, and exploitable vulnerabilities and security weaknesses are corrected.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-11.5', title: 'Network Intrusion and Unexpected File Changes Are Detected and Responded To', description: 'Network intrusions and unexpected file changes are detected and responded to.', priority: '1', control_type: 'technical' },
      { control_id: 'PCI-11.6', title: 'Unauthorized Changes on Payment Pages Are Detected', description: 'Unauthorized changes on payment pages are detected and responded to.', priority: '1', control_type: 'technical' },
      // Requirement 12: Support Information Security with Policies
      { control_id: 'PCI-12.1', title: 'Comprehensive Information Security Policy Established', description: 'A comprehensive information security policy that governs and provides direction for protection of the entity\'s information assets is known and current.', priority: '1', control_type: 'policy' },
      { control_id: 'PCI-12.2', title: 'Acceptable Use Policies for End-User Technologies', description: 'Acceptable use policies for end-user technologies are defined and implemented.', priority: '2', control_type: 'policy' },
      { control_id: 'PCI-12.3', title: 'Risks to the CDE Are Formally Identified, Evaluated, and Managed', description: 'Risks to the cardholder data environment are formally identified, evaluated, and managed.', priority: '1', control_type: 'strategic' },
      { control_id: 'PCI-12.4', title: 'PCI DSS Compliance Is Managed', description: 'PCI DSS compliance is managed.', priority: '1', control_type: 'organizational' },
      { control_id: 'PCI-12.5', title: 'PCI DSS Scope Is Documented and Validated', description: 'PCI DSS scope is documented and validated.', priority: '1', control_type: 'organizational' },
      { control_id: 'PCI-12.6', title: 'Security Awareness Education Is Ongoing', description: 'Security awareness education is an ongoing activity.', priority: '2', control_type: 'organizational' },
      { control_id: 'PCI-12.7', title: 'Personnel Are Screened', description: 'Personnel are screened to reduce risks from insider threats.', priority: '2', control_type: 'organizational' },
      { control_id: 'PCI-12.8', title: 'Risk Posed by Third Parties Is Managed', description: 'Risk posed by third parties with access to cardholder data or the CDE is managed.', priority: '1', control_type: 'strategic' },
      { control_id: 'PCI-12.9', title: 'Third-Party Responsibility for PCI DSS Compliance Is Supported', description: 'Third parties support their customers\' PCI DSS compliance.', priority: '2', control_type: 'strategic' },
      { control_id: 'PCI-12.10', title: 'Suspected and Confirmed Security Incidents Are Responded To Immediately', description: 'Suspected and confirmed security incidents that could impact the CDE are responded to immediately.', priority: '1', control_type: 'organizational' },
    ]
  },
  ...
  // === IT GOVERNANCE ===
  {
    ...
    description: 'ISACA COBIT 2019 IT governance and management framework. Covers 40 governance and management objectives across five domains: Evaluate, Direct and Monitor (EDM); Align, Plan and Organize (APO); Build, Acquire and Implement (BAI); Deliver, Service and Support (DSS); and Monitor, Evaluate and Assess (MEA).',
    controls: [
      // EDM — Evaluate, Direct and Monitor
      { control_id: 'EDM01', title: 'Ensured Governance Framework Setting and Maintenance', description: 'Analyze and articulate the requirements for the governance of enterprise IT and establish and maintain effective enabling structures, principles, processes, and practices.', priority: '1', control_type: 'strategic' },
      { control_id: 'EDM02', title: 'Ensured Benefits Delivery', description: 'Secure optimal value from IT-enabled initiatives, services, and assets; cost-efficient delivery of solutions and services; and a reliable, accurate picture of costs and likely benefits.', priority: '1', control_type: 'strategic' },
      { control_id: 'EDM03', title: 'Ensured Risk Optimization', description: 'Ensure that IT-related enterprise risk does not exceed the risk appetite and risk tolerance of the board, and that the impact of IT risk is transparent to stakeholders.', priority: '1', control_type: 'strategic' },
      { control_id: 'EDM04', title: 'Ensured Resource Optimization', description: 'Ensure that adequate and sufficient IT-related capabilities are available to support enterprise objectives effectively at optimal cost.', priority: '2', control_type: 'strategic' },
      { control_id: 'EDM05', title: 'Ensured Stakeholder Engagement', description: 'Ensure that enterprise IT stakeholder needs, conditions, and options are evaluated to determine balanced, agreed enterprise objectives.', priority: '2', control_type: 'organizational' },
      // APO — Align, Plan and Organize
      { control_id: 'APO01', title: 'Managed I&T Management Framework', description: 'Clarify and maintain the governance of enterprise I&T by implementing and maintaining mechanisms and authorities for managing information and technology.', priority: '1', control_type: 'organizational' },
      { control_id: 'APO02', title: 'Managed Strategy', description: 'Provide a holistic view of the current business and IT environment to ensure enterprise strategy and related technology-enabled opportunities are aligned.', priority: '1', control_type: 'strategic' },
      { control_id: 'APO03', title: 'Managed Enterprise Architecture', description: 'Represent the different building blocks that make up the enterprise and their interrelationships to achieve enterprise objectives effectively and efficiently.', priority: '2', control_type: 'strategic' },
      { control_id: 'APO04', title: 'Managed Innovation', description: 'Maintain awareness of information and technology trends; identify innovation opportunities; and plan how to benefit from innovation in relation to business needs.', priority: '3', control_type: 'strategic' },
      { control_id: 'APO05', title: 'Managed Portfolio', description: 'Execute the strategic direction for investments in line with the enterprise architecture vision and the desired characteristics of investment and related services portfolios.', priority: '2', control_type: 'strategic' },
      { control_id: 'APO06', title: 'Managed Budget and Costs', description: 'Manage IT-related financial activities in both the business and IT functions, covering budget, cost, and benefit management, and prioritization of spending.', priority: '2', control_type: 'organizational' },
      { control_id: 'APO07', title: 'Managed Human Resources', description: 'Provide a structured approach to ensure optimal structuring, placement, decision rights, and skills of human resources to meet enterprise objectives.', priority: '2', control_type: 'organizational' },
      { control_id: 'APO08', title: 'Managed Relationships', description: 'Manage relationships between business and IT in a formalized and transparent way that ensures a focus on achieving a common and shared goal.', priority: '2', control_type: 'organizational' },
      { control_id: 'APO09', title: 'Managed Service Agreements', description: 'Align IT-enabled services and service levels with enterprise needs and expectations, including identification, specification, design, publishing, agreement, and monitoring.', priority: '2', control_type: 'organizational' },
      { control_id: 'APO10', title: 'Managed Vendors', description: 'Manage IT-related services provided by all types of suppliers to meet enterprise requirements, including selection of suppliers, management of relationships, and review of performance.', priority: '2', control_type: 'organizational' },
      { control_id: 'APO11', title: 'Managed Quality', description: 'Define and communicate quality requirements in all processes, procedures, and related enterprise outcomes; enable controls, ongoing monitoring, and the use of proven practices and standards.', priority: '2', control_type: 'organizational' },
      { control_id: 'APO12', title: 'Managed Risk', description: 'Continually identify, assess, and reduce IT-related risk within levels of tolerance set by enterprise management.', priority: '1', control_type: 'strategic' },
      { control_id: 'APO13', title: 'Managed Security', description: 'Define, operate, and monitor a system for information security management aligned with strategic direction.', priority: '1', control_type: 'technical' },
      { control_id: 'APO14', title: 'Managed Data', description: 'Manage enterprise data as a key resource; define, operate, and monitor policies and processes for data governance and management throughout the data lifecycle.', priority: '1', control_type: 'technical' },
      // BAI — Build, Acquire and Implement
      { control_id: 'BAI01', title: 'Managed Programs', description: 'Manage all programs from the investment portfolio in alignment with enterprise strategy and in a coordinated way, realizing benefits and delivering required capabilities on time and budget.', priority: '2', control_type: 'organizational' },
      { control_id: 'BAI02', title: 'Managed Requirements Definition', description: 'Identify solutions and analyze requirements before acquisition or creation to ensure they are aligned with enterprise strategic requirements covering business processes, applications, data, and infrastructure.', priority: '2', control_type: 'organizational' },
      { control_id: 'BAI03', title: 'Managed Solutions Identification and Build', description: 'Establish and maintain identified solutions in line with enterprise requirements covering design, development, procurement, partnering, and configuration.', priority: '2', control_type: 'technical' },
      { control_id: 'BAI04', title: 'Managed Availability and Capacity', description: 'Balance current and future needs for availability, performance, and capacity with cost-effective service provision.', priority: '1', control_type: 'technical' },
      { control_id: 'BAI05', title: 'Managed Organizational Change', description: 'Maximize the likelihood of successfully implementing enterprise-wide change quickly and with reduced risk by covering the complete lifecycle of change.', priority: '2', control_type: 'organizational' },
      { control_id: 'BAI06', title: 'Managed IT Changes', description: 'Manage all changes to IT infrastructure and applications in a controlled manner, including standard changes, emergency changes, and maintenance, minimizing risk to IT stability.', priority: '1', control_type: 'technical' },
      { control_id: 'BAI07', title: 'Managed IT Change Acceptance and Transitioning', description: 'Accept and make operational new solutions, including implementation planning, system and data conversion, acceptance testing, and communication.', priority: '2', control_type: 'technical' },
      { control_id: 'BAI08', title: 'Managed Knowledge', description: 'Maintain the availability of relevant, current, validated, and reliable knowledge to support all process activities and facilitate decision making.', priority: '3', control_type: 'organizational' },
      { control_id: 'BAI09', title: 'Managed Assets', description: 'Manage IT assets through their lifecycle to make certain that their use delivers value at optimal cost, remain in service for the intended time, and are retired and disposed of appropriately.', priority: '2', control_type: 'technical' },
      { control_id: 'BAI10', title: 'Managed Configuration', description: 'Define and maintain descriptions and relationships between key resources and capabilities required to deliver IT-enabled services; include collecting configuration information, validating and auditing that information, and updating the configuration repository.', priority: '1', control_type: 'technical' },
      { control_id: 'BAI11', title: 'Managed Projects', description: 'Manage all projects within the investment portfolio in alignment with enterprise strategy and coordinated with the program management, realizing benefits and delivering on time and budget.', priority: '2', control_type: 'organizational' },
      // DSS — Deliver, Service and Support
      { control_id: 'DSS01', title: 'Managed Operations', description: 'Coordinate and execute the activities and operational procedures required to deliver internal and outsourced IT services, including the execution of predefined standard operating procedures and required monitoring activities.', priority: '1', control_type: 'technical' },
      { control_id: 'DSS02', title: 'Managed Service Requests and Incidents', description: 'Provide timely and effective response to user requests and resolution of all types of incidents, restoring normal service, recording and fulfilling user requests and resolving all incidents.', priority: '1', control_type: 'organizational' },
      { control_id: 'DSS03', title: 'Managed Problems', description: 'Identify and classify problems and their root causes and provide timely resolution to prevent recurring incidents, and recommend improvements.', priority: '2', control_type: 'organizational' },
      { control_id: 'DSS04', title: 'Managed Continuity', description: 'Establish and maintain a plan to enable the business and IT to respond to incidents and disruptions in order to continue operation of critical business processes and required IT services.', priority: '1', control_type: 'organizational' },
      { control_id: 'DSS05', title: 'Managed Security Services', description: 'Protect enterprise information to maintain the level of information security risk acceptable to the enterprise in accordance with the security policy.', priority: '1', control_type: 'technical' },
      { control_id: 'DSS06', title: 'Managed Business Process Controls', description: 'Define and maintain appropriate business process controls to ensure that information related to and processed by in-house or outsourced business processes satisfies all relevant information control requirements.', priority: '2', control_type: 'technical' },
      // MEA — Monitor, Evaluate and Assess
      { control_id: 'MEA01', title: 'Managed Performance and Conformance Monitoring', description: 'Collect, validate, and evaluate business, IT, and process goals and metrics and monitor that processes are performing against agreed performance and conformance goals and metrics.', priority: '1', control_type: 'organizational' },
      { control_id: 'MEA02', title: 'Managed System of Internal Control', description: 'Continuously monitor and evaluate the control environment, including self-assessments and independent assurance reviews, to ensure internal controls are operating effectively.', priority: '1', control_type: 'organizational' },
      { control_id: 'MEA03', title: 'Managed Compliance with External Requirements', description: 'Evaluate that IT processes and IT-supported business processes are compliant with laws, regulations, and contractual requirements and verify whether compliance requirements are being met.', priority: '1', control_type: 'organizational' },
      { control_id: 'MEA04', title: 'Managed Assurance', description: 'Obtain assurance about whether IT processes are performing effectively, efficiently, and in compliance with requirements through structured assurance initiatives, including independent reviews, audits, and certifications.', priority: '2', control_type: 'organizational' },
    ]
  },
  ...
  },
  {
    ...
    description: 'The CIS Controls (formerly SANS Top 20) provide a prioritized set of actions to protect organizations and data from known cyber attack vectors. Version 8 reorganizes controls into 18 top-level controls aligned around Implementation Groups (IG1/IG2/IG3) for organizations of varying security maturity.',
    controls: [
      { control_id: 'CIS-1',  title: 'Inventory and Control of Enterprise Assets',   description: 'Actively manage (inventory, track, and correct) all enterprise assets connected to the infrastructure physically, virtually, remotely, and those within cloud environments to accurately know the totality of assets to be monitored and protected.', priority: 'critical', control_type: 'operational' },
      { control_id: 'CIS-2',  title: 'Inventory and Control of Software Assets',     description: 'Actively manage (inventory, track, and correct) all software on the network so that only authorized software is installed and can execute, and that unauthorized and unmanaged software is found and prevented from installation or execution.', priority: 'critical', control_type: 'operational' },
      { control_id: 'CIS-3',  title: 'Data Protection',                               description: 'Develop processes and technical controls to identify, classify, securely handle, retain, and dispose of data.', priority: 'critical', control_type: 'technical' },
      { control_id: 'CIS-4',  title: 'Secure Configuration of Enterprise Assets and Software', description: 'Establish and maintain the secure configuration of enterprise assets (end-user devices, network devices, servers, and cloud assets) and software (operating systems and applications).', priority: 'high', control_type: 'technical' },
      { control_id: 'CIS-5',  title: 'Account Management',                            description: 'Use processes and tools to assign and manage authorization to credentials for user accounts, including administrator accounts, as well as service accounts, to enterprise assets and software.', priority: 'critical', control_type: 'technical' },
      { control_id: 'CIS-6',  title: 'Access Control Management',                    description: 'Use processes and tools to create, assign, manage, and revoke access credentials and privileges for user, administrator, and service accounts for enterprise assets and software.', priority: 'critical', control_type: 'technical' },
      { control_id: 'CIS-7',  title: 'Continuous Vulnerability Management',          description: 'Develop a plan to continuously assess and track vulnerabilities on all enterprise assets within the enterprise\'s infrastructure, in order to remediate, and minimize, the window of opportunity for attackers.', priority: 'high', control_type: 'technical' },
      { control_id: 'CIS-8',  title: 'Audit Log Management',                         description: 'Collect, alert, review, and retain audit logs of events that could help detect, understand, or recover from an attack.', priority: 'high', control_type: 'technical' },
      { control_id: 'CIS-9',  title: 'Email and Web Browser Protections',            description: 'Improve protections and detections of threats from email and web vectors, as these are opportunities for attackers to manipulate human behavior through direct engagement.', priority: 'high', control_type: 'technical' },
      { control_id: 'CIS-10', title: 'Malware Defenses',                             description: 'Prevent or control the installation, spread, and execution of malicious applications, code, or scripts on enterprise assets.', priority: 'high', control_type: 'technical' },
      { control_id: 'CIS-11', title: 'Data Recovery',                                description: 'Establish and maintain data recovery practices sufficient to restore in-scope enterprise assets to a pre-incident and trusted state.', priority: 'high', control_type: 'operational' },
      { control_id: 'CIS-12', title: 'Network Infrastructure Management',            description: 'Establish and maintain the secure configuration of network infrastructure assets (physical and virtual).', priority: 'high', control_type: 'technical' },
      { control_id: 'CIS-13', title: 'Network Monitoring and Defense',               description: 'Operate processes and tooling to establish and maintain comprehensive network monitoring and defense against security threats across the enterprise\'s network infrastructure and user base.', priority: 'high', control_type: 'technical' },
      { control_id: 'CIS-14', title: 'Security Awareness and Skills Training',       description: 'Establish and maintain a security awareness program to influence behavior among the workforce to be security conscious and properly skilled to reduce cybersecurity risks to the enterprise.', priority: 'medium', control_type: 'administrative' },
      { control_id: 'CIS-15', title: 'Service Provider Management',                  description: 'Develop a process to evaluate service providers who hold sensitive data, or are responsible for an enterprise\'s critical IT platforms or processes, to ensure these providers are protecting those platforms and data appropriately.', priority: 'medium', control_type: 'administrative' },
      { control_id: 'CIS-16', title: 'Application Software Security',                description: 'Manage the security life cycle of in-house developed, hosted, or acquired software in order to prevent, detect, and remediate security weaknesses before they can impact the enterprise.', priority: 'high', control_type: 'technical' },
      { control_id: 'CIS-17', title: 'Incident Response Management',                 description: 'Establish a program to develop and maintain an incident response capability (e.g., policies, plans, procedures, defined roles, training, and communications) to prepare, detect, and quickly respond to an attack.', priority: 'high', control_type: 'administrative' },
      { control_id: 'CIS-18', title: 'Penetration Testing',                          description: 'Test the effectiveness and resiliency of enterprise assets through identifying and exploiting weaknesses in controls (people, processes, and technology), and simulating the objectives and actions of an attacker.', priority: 'medium', control_type: 'technical' },
    ]
  },
];
...
async function seed() {
  ...
  try {
    ...
    const mappingPairs = [
      ...
      // COBIT 2019 <-> NIST 800-53
      ['APO12', 'cobit_2019', 'PM-9',  'nist_800_53', 90],
      ['APO13', 'cobit_2019', 'PL-2',  'nist_800_53', 85],
      ['APO14', 'cobit_2019', 'PM-23', 'nist_800_53', 92],
      ['BAI06', 'cobit_2019', 'CM-3',  'nist_800_53', 90],
      ['BAI10', 'cobit_2019', 'CM-8',  'nist_800_53', 92],
      ['DSS04', 'cobit_2019', 'CP-2',  'nist_800_53', 88],
      ['DSS05', 'cobit_2019', 'PL-2',  'nist_800_53', 82],
      ['MEA02', 'cobit_2019', 'CA-2',  'nist_800_53', 90],
      ['MEA03', 'cobit_2019', 'CA-7',  'nist_800_53', 88],
      // FedRAMP Moderate <-> NIST 800-53
      ['FED-AC-2',  'fedramp_moderate', 'AC-2',  'nist_800_53', 95],
      ['FED-AU-2',  'fedramp_moderate', 'AU-2',  'nist_800_53', 95],
      ['FED-CA-7',  'fedramp_moderate', 'CA-7',  'nist_800_53', 92],
      ['FED-CM-2',  'fedramp_moderate', 'CM-2',  'nist_800_53', 95],
      ['FED-IA-2',  'fedramp_moderate', 'IA-2',  'nist_800_53', 95],
      ['FED-RA-5',  'fedramp_moderate', 'RA-5',  'nist_800_53', 92],
      ['FED-SC-7',  'fedramp_moderate', 'SC-7',  'nist_800_53', 95],
      ['FED-SI-2',  'fedramp_moderate', 'SI-2',  'nist_800_53', 95],
      // FISCAM <-> NIST 800-53 Rev 5
      ['SM-1',    'fiscam', 'PM-9',  'nist_800_53', 88],
      ['SM-2',    'fiscam', 'RA-3',  'nist_800_53', 92],
      ['SM-3',    'fiscam', 'PL-2',  'nist_800_53', 85],
      ['SM-4',    'fiscam', 'CA-7',  'nist_800_53', 78],
      ['AC-FM-1', 'fiscam', 'AC-2',  'nist_800_53', 92],
      ['AC-FM-2', 'fiscam', 'AC-3',  'nist_800_53', 90],
      ['AC-FM-3', 'fiscam', 'IA-2',  'nist_800_53', 92],
      ['AC-FM-4', 'fiscam', 'SC-7',  'nist_800_53', 85],
      ['CC-1',    'fiscam', 'CM-3',  'nist_800_53', 92],
      ['CC-2',    'fiscam', 'CM-2',  'nist_800_53', 90],
      ['SC-1',    'fiscam', 'AC-5',  'nist_800_53', 95],
      ['CP-FM-1', 'fiscam', 'CP-2',  'nist_800_53', 92],
      // FISCAM <-> FFIEC IT Examination Handbook
      ['SM-1',    'fiscam', 'FFIEC-IS-1',  'ffiec', 90],
      ['SM-2',    'fiscam', 'FFIEC-IS-2',  'ffiec', 92],
      ['SM-3',    'fiscam', 'FFIEC-IS-1',  'ffiec', 85],
      ['SM-4',    'fiscam', 'FFIEC-CYB-1', 'ffiec', 78],
      ['AC-FM-1', 'fiscam', 'FFIEC-AM-1',  'ffiec', 88],
      ['AC-FM-3', 'fiscam', 'FFIEC-AM-1',  'ffiec', 90],
      ['CC-1',    'fiscam', 'FFIEC-OPS-2', 'ffiec', 92],
      ['SC-1',    'fiscam', 'FFIEC-AUD-2', 'ffiec', 80],
      ['CP-FM-1', 'fiscam', 'FFIEC-BCP-1', 'ffiec', 88],
      // FISCAM <-> COBIT 2019
      ['SM-1',    'fiscam', 'APO01',  'cobit_2019', 80],
      ['SM-2',    'fiscam', 'APO12',  'cobit_2019', 88],
      ['CC-1',    'fiscam', 'BAI06',  'cobit_2019', 90],
      ['CC-2',    'fiscam', 'BAI10',  'cobit_2019', 92],
      ['SC-1',    'fiscam', 'MEA02',  'cobit_2019', 88],
      ['CP-FM-1', 'fiscam', 'DSS04',  'cobit_2019', 90],
      // FISCAM <-> NIST CSF 2.0
      ['SM-1',    'fiscam', 'GV.RM-01', 'nist_csf_2.0', 85],
      ['SM-2',    'fiscam', 'ID.RA-03', 'nist_csf_2.0', 88],
      ['SM-3',    'fiscam', 'GV.PO-01', 'nist_csf_2.0', 88],
      ['AC-FM-1', 'fiscam', 'PR.AA-01', 'nist_csf_2.0', 90],
      ['AC-FM-3', 'fiscam', 'PR.AA-02', 'nist_csf_2.0', 92],
      ['CC-1',    'fiscam', 'PR.PS-01', 'nist_csf_2.0', 85],
      ['CC-2',    'fiscam', 'PR.PS-01', 'nist_csf_2.0', 82],
      ['SC-1',    'fiscam', 'GV.RR-02', 'nist_csf_2.0', 78],
      ['CP-FM-1', 'fiscam', 'PR.IR-01', 'nist_csf_2.0', 80],
      // FISCAM <-> SR 11-7 Model Risk Management
      ['SM-1',    'fiscam', 'SR117-G-1', 'sr_11_7', 82],
      ['SM-2',    'fiscam', 'SR117-I-2', 'sr_11_7', 78],
      ['SM-3',    'fiscam', 'SR117-G-1', 'sr_11_7', 85],
      ['SM-4',    'fiscam', 'SR117-G-3', 'sr_11_7', 73],
      ['SM-4',    'fiscam', 'SR117-G-4', 'sr_11_7', 72],
      ['CC-1',    'fiscam', 'SR117-G-5', 'sr_11_7', 88],
      ['CC-2',    'fiscam', 'SR117-D-2', 'sr_11_7', 75],
      ['SC-1',    'fiscam', 'SR117-V-1', 'sr_11_7', 80],
      // FISCAM <-> SEC AI Risk Management
      ['SM-2',    'fiscam', 'SEC-AI-3',  'sec_markets_ai_risk', 80],
      ['SM-1',    'fiscam', 'SEC-AI-5',  'sec_markets_ai_risk', 78],
      ['SM-3',    'fiscam', 'SEC-AI-5',  'sec_markets_ai_risk', 80],
      ['SC-1',    'fiscam', 'SEC-AI-7',  'sec_markets_ai_risk', 72],
      ['CC-1',    'fiscam', 'SEC-AI-8',  'sec_markets_ai_risk', 70],
      ['SM-2',    'fiscam', 'SEC-AI-10', 'sec_markets_ai_risk', 74],
      // FISCAM <-> FINRA Supervisory AI
      ['SM-1',    'fiscam', 'FINRA-SUP-1',  'finra_supervisory_ai', 80],
      ['SM-3',    'fiscam', 'FINRA-SUP-1',  'finra_supervisory_ai', 75],
      ['CC-1',    'fiscam', 'FINRA-SUP-9',  'finra_supervisory_ai', 82],
      ['SM-4',    'fiscam', 'FINRA-SUP-6',  'finra_supervisory_ai', 70],
      ['SC-1',    'fiscam', 'FINRA-SUP-1',  'finra_supervisory_ai', 72],
      ['SM-2',    'fiscam', 'FINRA-SUP-8',  'finra_supervisory_ai', 72],
      ['AC-FM-1', 'fiscam', 'FINRA-SUP-10', 'finra_supervisory_ai', 68],
      // CMMC 2.0 Level 2 <-> NIST 800-171 Rev 3 (CMMC L2 is 800-171 by design)
      ...
      // NIST 800-171 Rev 3 <-> NIST 800-53 Rev 5 (subset relationship)
      ...
      // HITECH Act <-> HIPAA Security Rule
      ['HITECH-13402',  'hitech', 'HIPAA-164.308(a)(6)', 'hipaa', 88],
      ['HITECH-13407',  'hitech', 'HIPAA-164.308(a)(6)', 'hipaa', 85],
      ['HITECH-13408',  'hitech', 'HIPAA-164.314(a)(1)', 'hipaa', 90],
      ['HITECH-13410',  'hitech', 'HIPAA-164.314(a)(1)', 'hipaa', 92],
      ['HITECH-13410e', 'hitech', 'HIPAA-164.312(b)',    'hipaa', 92],
      ['HITECH-13412',  'hitech', 'HIPAA-164.308(a)(8)', 'hipaa', 88],
      ['HITECH-13412a', 'hitech', 'HIPAA-164.308(a)(1)', 'hipaa', 85],
      ['HITECH-13412b', 'hitech', 'HIPAA-164.312(e)(1)', 'hipaa', 92],
      ['HITECH-13412c', 'hitech', 'HIPAA-164.312(b)',    'hipaa', 92],
      ['HITECH-13412d', 'hitech', 'HIPAA-164.312(c)(1)', 'hipaa', 92],
      ['HITECH-13405a', 'hitech', 'HIPAA-164.308(a)(4)', 'hipaa', 82],
      // GDPR <-> ISO 27701 (privacy extension of 27001)
      ...
      // ISO 27017 <-> ISO 27001 (cloud security extension)
      ['CSR-1', 'iso_27017', 'A.5.23', 'iso_27001', 92],
      ['CDP-1', 'iso_27017', 'A.5.23', 'iso_27001', 90],
      ['VM-1',  'iso_27017', 'A.8.9',  'iso_27001', 88],
      ['CNS-1', 'iso_27017', 'A.8.20', 'iso_27001', 88],
      ['CAC-1', 'iso_27017', 'A.5.15', 'iso_27001', 88],
      ['CML-1', 'iso_27017', 'A.8.16', 'iso_27001', 92],
      ['CIM-1', 'iso_27017', 'A.5.24', 'iso_27001', 90],
      ['VSM-1', 'iso_27017', 'A.8.9',  'iso_27001', 85],
      ['CSA-1', 'iso_27017', 'A.5.23', 'iso_27001', 88],
      // ISO 27018 <-> ISO 27701
      ['PC-1', 'iso_27018', 'CMF-1', 'iso_27701', 90],
      ['PD-1', 'iso_27018', 'DSR-1', 'iso_27701', 92],
      ['PT-1', 'iso_27018', 'PNT-1', 'iso_27701', 92],
      ['CT-1', 'iso_27018', 'CBT-1', 'iso_27701', 95],
      ['SP-1', 'iso_27018', 'TPA-1', 'iso_27701', 90],
      ['PB-1', 'iso_27018', 'PIR-1', 'iso_27701', 92],
      ['PR-1', 'iso_27018', 'DRE-1', 'iso_27701', 92],
      ['PA-1', 'iso_27018', 'PAC-1', 'iso_27701', 85],
      // ISO 27701 <-> ISO 27001 (privacy extension)
      ['PG-1',  'iso_27701', 'A.5.1',  'iso_27001', 88],
      ['PIR-1', 'iso_27701', 'A.5.24', 'iso_27001', 90],
      ['DPR-1', 'iso_27701', 'A.5.9',  'iso_27001', 85],
      ['PTA-1', 'iso_27701', 'A.6.3',  'iso_27001', 85],
      // ISO 27005 <-> ISO 31000 (risk management)
      ['RC-1',  'iso_27005', 'RAP-1', 'iso_31000', 92],
      ['IA-1',  'iso_27005', 'RIT-1', 'iso_31000', 88],
      ['TH-1',  'iso_27005', 'RIT-1', 'iso_31000', 88],
      ['VI-1',  'iso_27005', 'RIT-1', 'iso_31000', 85],
      ['RA-1',  'iso_27005', 'RAE-1', 'iso_31000', 92],
      ['RE-1',  'iso_27005', 'RAE-1', 'iso_31000', 90],
      ['RT-1',  'iso_27005', 'RTP-1', 'iso_31000', 95],
      ['RM-1',  'iso_27005', 'RMC-1', 'iso_31000', 92],
      ['RCP-1', 'iso_27005', 'RCC-1', 'iso_31000', 92],
      // ISO 31000 <-> NIST CSF 2.0
      ['RMF-1', 'iso_31000', 'GV.RM-01', 'nist_csf_2.0', 90],
      ['LCR-1', 'iso_31000', 'GV.RR-01', 'nist_csf_2.0', 88],
      ['RMP-1', 'iso_31000', 'GV.PO-01', 'nist_csf_2.0', 88],
      ['RIT-1', 'iso_31000', 'ID.RA-03', 'nist_csf_2.0', 90],
      ['RAE-1', 'iso_31000', 'ID.RA-04', 'nist_csf_2.0', 90],
      ['RTP-1', 'iso_31000', 'GV.RM-02', 'nist_csf_2.0', 85],
      ['RMC-1', 'iso_31000', 'GV.RM-01', 'nist_csf_2.0', 82],
      // ISO 42005 <-> ISO 42001
      ['IA-1',  'iso_42005', 'ISO42-8.4',    'iso_42001', 95],
      ['IA-2',  'iso_42005', 'ISO42-4.2',    'iso_42001', 88],
      ['IA-3',  'iso_42005', 'ISO42-A.4.1',  'iso_42001', 92],
      ['IA-4',  'iso_42005', 'ISO42-A.7.2',  'iso_42001', 88],
      ['IA-5',  'iso_42005', 'ISO42-A.6.2',  'iso_42001', 92],
      ['IA-6',  'iso_42005', 'ISO42-8.2',    'iso_42001', 92],
      ['IA-7',  'iso_42005', 'ISO42-8.3',    'iso_42001', 92],
      ['IA-8',  'iso_42005', 'ISO42-A.4.1',  'iso_42001', 88],
      ['IA-9',  'iso_42005', 'ISO42-A.10.1', 'iso_42001', 85],
      ['IA-10', 'iso_42005', 'ISO42-9.1',    'iso_42001', 90],
      // ISO 42005 <-> NIST AI RMF
      ['IA-1',  'iso_42005', 'MAP-1',     'nist_ai_rmf', 92],
      ['IA-2',  'iso_42005', 'MAP-2',     'nist_ai_rmf', 88],
      ['IA-3',  'iso_42005', 'MAP-1',     'nist_ai_rmf', 90],
      ['IA-5',  'iso_42005', 'MAP-5',     'nist_ai_rmf', 92],
      ['IA-6',  'iso_42005', 'MEASURE-2', 'nist_ai_rmf', 88],
      ['IA-7',  'iso_42005', 'MANAGE-1',  'nist_ai_rmf', 90],
      ['IA-9',  'iso_42005', 'MAP-4',     'nist_ai_rmf', 88],
      ['IA-10', 'iso_42005', 'MEASURE-3', 'nist_ai_rmf', 92],
