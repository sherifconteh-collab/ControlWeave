...
/**
 * Export Security Reports and Logs to Wiki
 * 
 * This script exports security-related reports and audit logs to the wiki
...
function generateIndexFile(timestamp) {
  ...
  content += `- **Audit Logs Reports** - AU-2 compliant audit trail summaries\n`;
  content += `- **Vulnerability Findings** - STIG, SBOM, and scanner results\n`;
  content += `- **Controls Status** - Security control implementation status\n`;
  content += `- **DISA STIG Compliance** - Application security STIG compliance\n\n`;
  ...
  content += `## Automation\n\n`;
  content += `Security reports are automatically generated and exported by running:\n\n`;
  content += `\`\`\`bash\n`;
  content += `node scripts/export-security-reports.js\n`;
  content += `\`\`\`\n\n`;
  
  content += `Recommended schedule: Daily or weekly automated export\n\n`;
