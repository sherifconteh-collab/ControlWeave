...
async function seed() {
  ...
  try {
    ...
    // or score -- caught in the ai-grc-platform port when this tripped on
    // 894 rows that were all mapping_type='related' at score 75, nowhere
    // near the auto-credit bar.
