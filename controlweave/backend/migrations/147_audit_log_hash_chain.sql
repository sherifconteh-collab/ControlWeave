-- Migration 147: Hash-chain audit records (NIST AU-9(3), AU-10)
--
-- What already exists makes audit_logs tamper-RESISTANT: migration 121 added triggers
...
SELECT 'Migration 147 completed.' AS result;
