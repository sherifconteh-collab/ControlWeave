-- Migration 127: RBAC document import for AI-assisted access governance
--
...
-- access governance module (migration 126) and have AI analyze it: extract
-- the documented roles and duties, map them to ControlWeave's permission
...
SELECT 'Migration 127 completed.' AS result;
