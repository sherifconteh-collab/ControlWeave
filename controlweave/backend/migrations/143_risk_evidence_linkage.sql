-- =============================================================================
-- 143_risk_evidence_linkage.sql
--
-- Ships alongside 140 (risk <-> POA&M), 141 (POA&M <-> control) and
-- 142 (risk <-> vendor). This is the last of the register's unconnected edges.
--
-- Migration 136 connected risks to controls, assets and objectives; 140 added
-- remediation and 142 added third parties. Evidence was the remaining gap.
-- Evidence has been linkable to controls since migration 009
