-- Migration 128: Row-Level Security for access governance tables
--
-- Why: migration 104 applied defense-in-depth RLS to a curated set of the
...
-- tables added in 126/127 -- SoD rules, access review campaigns/items, and
...
--
-- Policy behavior (identical to migration 104): permissive when app.org_id
...
-- equally to the tables migration 104 already covers.
...
SELECT 'Migration 128 completed.' AS result;
