-- Migration 104: Row-Level Security (defense-in-depth)
--
...
--     Routes call withOrgContext(orgId, fn) in database.js to activate this.
--
...
-- evidence (conditional: table may not exist in community edition)
DO $$
BEGIN
