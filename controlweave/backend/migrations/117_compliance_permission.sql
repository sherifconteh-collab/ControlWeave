-- Migration 117: Seed the compliance.read / compliance.manage permissions
--
...
-- Ships in the feature-audit-fixes batch (v4.3.x follow-up).
...
SELECT 'Migration 117 completed.' AS result;
