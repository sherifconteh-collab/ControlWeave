-- Migration 124: Pending control assessments (AI-suggested status changes with approval)
--
...
-- the AI proposes, a human with controls.write approves or rejects, and
-- only approval ever touches control_implementations. Mirrors the
-- established "never auto-accept AI output without human validation"
-- principle already documented in .claude/rules/evidence.md.
