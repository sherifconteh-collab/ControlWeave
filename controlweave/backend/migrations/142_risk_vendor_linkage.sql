-- =============================================================================
-- 142_risk_vendor_linkage.sql
--
-- Ships in the same release as 140 (risk <-> POA&M) and 141 (POA&M <-> control).
--
-- Migration 136 gave the risk register three link tables -- controls, assets and
