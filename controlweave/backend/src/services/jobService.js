  ...
  const result = await pool.query(
    `INSERT INTO compliance_snapshots
     ...
     SELECT
       ...
       -- 'verified' and 'satisfied_via_crosswalk' count as implemented here.
       -- Both were previously omitted, so the trend snapshots this job writes
       -- reported a materially lower percentage than the compliance gate did
       -- for the same organization on the same day, despite describing the
       -- same measure. Verifying a control, or earning it through a crosswalk,
       -- made the trend line go down.
