        ...
        await pool.query(
          ...
          [
            ...
            JSON.stringify({
              ...
              remediation_required: remediation_required ?? oldRow.remediation_required ?? false,
        ...
        await pool.query(
          ...
          [
            ...
            JSON.stringify({
              ...
              remediation_required: remediation_required ?? false,
...
router.use((err, req, res, next) => {
  if (err && err.name === 'MulterError') {
    return res.status(400).json({ success: false, error: err.message || 'Template upload failed' });
  }
  return next(err);
});
