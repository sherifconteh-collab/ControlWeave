...
// reads as unprotected to static analysis -- which is precisely what CodeQL
// flagged on the sibling repo's cmdb.js.
...
router.get('/vendors/:id', requirePermission('organizations.read'), async (req, res) => {
  try {
    ...
    // Register entries arising from this vendor (migration 142). The vendor's
