...
> This page and
> [`wiki/security/Vulnerability-Management.md`](../wiki/security/Vulnerability-Management.md)
...
![Vulnerability management dashboard showing imported findings, severity and source breakdowns, and summary statistics](../screenshots/vulnerabilities-dashboard-01.png)
...
![Import Scan Artifacts panel with file chooser and supported format list](../screenshots/vulnerability-import-scanner-01.png)
...
![SBOM dashboard showing component inventory and vulnerability scan results](../screenshots/sbom-vulnerability-scan-01.png)
...
![Framework artifact requirements listing expected scan evidence per framework](../screenshots/vulnerability-framework-requirements-01.png)
...
![Findings table with search box, standard selector, and source filter chips](../screenshots/vulnerability-filters-01.png)
...
![Vulnerability detail panel showing CVSS, CWE, source, due date, and the control impact workflow](../screenshots/vulnerability-detail-page-01.png)
...
![Control Impact Workflow showing per-control work items with their available actions](../screenshots/control-vulnerability-impact-01.png)
...
![Findings by source and by severity charts](../screenshots/vulnerability-metrics-dashboard-01.png)
...
![30 day trend chart showing finding volume over time](../screenshots/vulnerability-trend-chart-01.png)
...
- **Creating a POA&M directly from a finding.** Create POA&M items in the POA&M
  module — see the [POA&M guide](POAM.md).
...
- [DISA STIG compliance](../wiki/security/DISA-STIG-Compliance.md)
- [Security reports](../wiki/security/reports/README.md)
- [CMDB / asset inventory](CMDB.md)
