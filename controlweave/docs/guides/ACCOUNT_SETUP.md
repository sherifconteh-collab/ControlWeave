...
ControlWeave automatically signs you out after **30 minutes of inactivity** to protect your account. Any user interaction (mouse movement, keyboard input, scrolling) resets the timer.

**Account Lockout**

After multiple consecutive failed login attempts, your account is temporarily locked as a security measure. Wait for the lockout period to expire, then try again. If you've forgotten your password, use **Forgot Password** on the login page instead.
...
Logging out ends your active sessions. For most accounts, this will sign you out on all devices where you're currently logged in. If you've forgotten your password or suspect your account has been compromised, use **Forgot Password** on the login page — completing a password reset will also invalidate your existing sessions.
