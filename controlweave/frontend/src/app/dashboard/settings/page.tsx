        ...
        {activeTab === 'llm' && canManageSettings && (
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-sm text-gray-500 mb-6">Bring your own API keys to power AI Analysis features. Keys are stored securely.</p>
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">gemini-2.5-pro, gemini-2.5-flash</p>
                    </div>
                  </div>
