...
- Pair this with the [Leveraged Authorizations / OSCAL export](controlweave/frontend/src/app/dashboard/rmf) feature to also gate on authorization posture, not just raw control percentage.
