...
const TIER_OPTIONS: Array<{
  ...
  { key: 'govcloud', label: 'Gov Cloud & Advisory (Custom)', description: 'Regulated platform + hands-on consulting. FedRAMP, IL4/IL5, ITAR.', frameworkLimit: -1 },
];
