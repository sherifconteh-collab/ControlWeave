...
const features = [
  {
    ...
    title: '25+ Frameworks, Zero Overlap',
  ...
  },
  {
    ...
    title: 'Evidence That Never Goes Stale',
    desc: 'Upload artifacts, link to controls, and get automatic health scoring and freshness alerts.',
  },
  {
    icon: (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { num: '02', title: 'Evidence Collected, Not Chased.', desc: 'Upload evidence artifacts, link them to controls, and let AI score health and freshness. Get alerts before controls expire — not after your auditor flags them.' },
            ...
            {[
              {
                ...
                annualNote: null,
                description: 'Ideal for evaluation and small teams getting started.',
                features: [
                  'Up to 2 frameworks',
              ...
              },
              {
                ...
                monthlyPeriod: '/month',
                annualPeriod: '/year',
                annualNote: '$143/mo billed annually',
                annualCost: 'Equivalent to $143/mo billed annually',
                description: 'For small teams managing multiple compliance programs.',
                features: [
                  'Up to 5 frameworks',
                  'All core features',
                  'AI gap analysis',
              ...
              },
              {
                ...
                monthlyPeriod: '/month',
                annualPeriod: '/year',
                annualNote: '$457/mo billed annually',
                annualCost: 'Equivalent to $457/mo billed annually',
                description: 'Unlimited frameworks with full AI and CMDB access.',
                features: [
              ...
              },
              {
                ...
                monthlyPeriod: '/month',
                annualPeriod: '/year',
                annualNote: '$999/mo billed annually',
                annualCost: 'Equivalent to $999/mo billed annually',
                description: 'Advanced AI governance, dedicated support, and custom SLAs.',
                features: [
              ...
              },
              {
                ...
                monthlyPeriod: '/month',
                annualPeriod: '/year',
                annualNote: '$2,499/mo billed annually',
                annualCost: 'Equivalent to $2,499/mo billed annually',
                description: 'Maximum-scale AI governance utilities for large enterprises and MSPs.',
                features: [
