...
export const vulnerabilitiesAPI = {
  ...
  importScan: (formData: FormData) =>
    api.post('/vulnerabilities/import', formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
