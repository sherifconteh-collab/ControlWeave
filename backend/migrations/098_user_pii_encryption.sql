-- Migration 098: User PII field-level encryption
--
-- Adds email_hash column to users for HMAC-SHA-256 searchable indexing
...
--   email_hash   VARCHAR  — stores HMAC-SHA-256(email, HMAC_KEY) for O(1) lookup
