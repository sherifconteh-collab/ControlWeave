...
const { validateBody, isUuid, sanitizeInput } = require('../middleware/validate');
...
// ---------- Shared constants and helpers (extracted to ./organizations/_helpers) ----------
const {
  ...
  verifyOrgAccess,
} = require('./organizations/_helpers');
