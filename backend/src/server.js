...
const { emergencyModeGate } = require('./middleware/emergencyMode');
app.use(emergencyModeGate);
...
const autoEvidenceCollectionRoutes = require('./routes/autoEvidenceCollection');
...
app.use('/api/v1/auto-evidence', autoEvidenceCollectionRoutes);
